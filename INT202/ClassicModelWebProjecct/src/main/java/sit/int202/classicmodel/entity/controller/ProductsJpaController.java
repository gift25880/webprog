...
import sit.int202.classicmodel.entity.Productlines;
import sit.int202.classicmodel.entity.Orderdetails;
import java.util.ArrayList;
import java.util.List;
import javax.persistence.EntityManager;
import javax.persistence.EntityManagerFactory;
import sit.int202.classicmodel.entity.Products;
import sit.int202.classicmodel.entity.controller.exceptions.IllegalOrphanException;
...
public class ProductsJpaController implements Serializable {
    ...
    public int getProductsCount() {
     ...
     public List<Products> findProductsEntities(String qryParam) {
        EntityManager em = getEntityManager();
        try {
            Query qry = em.createNamedQuery("Products.findAllAttribute", Products.class);
            qry.setParameter("param", qryParam);
